...
###select the control then the group you want to parent to it (parent then child) then press the button which appears in the window when you run the script###
